...
public class WalletModelTest {
    ...
    public void walletStartBalance() {
        Wallet meMoneyHolder = new Wallet(new User());
    ...
    public void frozenToClosed() {
        ...
        assertThrows(IllegalWalletStatusException.class, meMoneyHolder::close);
    }
    ...
    public void closedToFrozen() {
        ...
        assertThrows(IllegalWalletStatusException.class, meMoneyHolder::freeze);
    }
    ...
    public void closedToActive() {
        ...
        assertThrows(IllegalWalletStatusException.class, meMoneyHolder::unfreeze);
    }
    ...
    public void depositToFrozen() {
        ...
        assertThrows(IllegalWalletStatusException.class, () -> meMoneyHolder.deposit(new Money(new BigDecimal("1.00"))));
    }
    ...
    public void debitFromFrozen() {
        ...
        assertThrows(IllegalWalletStatusException.class, () -> meMoneyHolder.debit(new Money(new BigDecimal("1.00"))));
    }
